...
namespace LTCSDL.DAL.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        //#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=.\\VUONGPRO;Initial Catalog=Northwind;Persist Security Info=True;User ID=vuongpro;Password=vuongpro1999;Pooling=False;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True;");
            }
        }
